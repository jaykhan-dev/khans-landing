...
function Bio() {
  ...
  return (
    <motion.div
      id="bio"
      className="grid lg:grid-cols-3 lg:w-2/3 mx-auto gap-4 p-4 relative my-20"
      initial="hidden"
      animate="visible"
      variants={variants}
    >
      ...
      <motion.div className="lg:col-span-2 z-50">
        <h1 className="text-6xl font-black">Jay Khan</h1>
        <div className="lg:flex items-center lg:space-x-2 uppercase text-xl tracking-wide my-12">
          <p className="flex items-center">
            <span className="font-black text-4xl mx-2">&#x2022;</span>
            {roles.development}
          </p>
